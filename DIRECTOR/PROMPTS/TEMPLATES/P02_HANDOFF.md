...
| T02 | [Task-Beschreibung] | P1 | OFFEN | Nächster Agent |
| T03 | [Task-Beschreibung] | P0 | 🟡 BLOCKED | [Grund des Blocks] |
...
1. **Was ist ein Task-Envelope und welche 3 Dateien enthält er?**
2. **Wann darf ein Agent stoppen und Bericht erstatten?**
3. **Was ist der [[Cheating Rollback]] und wann greift er?**

---

## 6. KOMMANDO-REFERENZ (Nützliche Befehle für den nächsten Agenten)

```bash
# Beispiel-Befehle aus dieser Session
[Kommando 1]  # Beschreibung
[Kommando 2]  # Beschreibung
```
